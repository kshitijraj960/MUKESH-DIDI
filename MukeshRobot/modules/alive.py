...
lol = "https://telegra.ph/file/c9bf09ab92ce5432b4cb7.jpg"
...
async def restart(client, m: Message):
    ...
    await m.reply_photo(
        lol,
        caption=f"""**🌷ʜᴇʏ, ɪ ᴀᴍ 『[𝐐𝐍 𝐑𝐎𝐁𝐎𝐓](f"t.me/{BOT_USERNAME}")』🎄**
   ╔═════ஜ۩۞۩ஜ════╗

   ♨️𝗠𝗔𝗗𝗘 𝗕𝗬 [𝗘𝗕𝗗 𝗤𝗡](https://t.me/EBD_QN)♨️
